...
In this way, zero values are accounted separetely in the regression process and do not enforce structural zeroes in the network.
...
the row- and column names match the depedenent variable (here the co-sponsorship matrix).
...
process even more. 
Alternatiely, these initial values can be calculated endogenously.
